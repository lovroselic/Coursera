...
def PrintFlow(reads):
        ...
        for e in edges:
            if e % 2 == 0:
                if GR.edges[e].u == u and GR.edges[e].v == v:
                    if GR.edges[e].visited == False:
                        GR.edges[e].visited = True
                        return e
        return None
    ...
    for r in reads:
        ...
        #print(edgeIndex,"Flow", flow, "capacity",GR.edges[edgeIndex].capacity, "lbound",l, "total", l + flow)
        flow = l + flow
        print(flow)
