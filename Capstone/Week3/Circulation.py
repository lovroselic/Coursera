...
#         #print("to source", len(GR.graph)-2, i, GR.in_[i])
#         GR.add_edge(len(GR.graph)-2, i, GR.in_[i], 0)
#         #GR.add_edge(len(GR.graph)-2, i, -GR.in_[i], 0)
#         #print("to sink", i, len(GR.graph)-1, GR.out_[i])
#         GR.add_edge(i, len(GR.graph)-1, GR.out_[i], 0)
#         #GR.add_edge(i, len(GR.graph)-1, -GR.out_[i], 0)
# =============================================================================
    for r in GR.reads:
        u,v,l = map(int, r)
...
# =============================================================================
#         GR.add_edge(source, u, l, 0)
#         GR.add_edge(v, sink, l, 0)
#         print("to source", source, u, l, 0)
#         print("to sink", v, sink, l, 0)
# =============================================================================
        
        GR.add_edge(source, u, GR.in_[u], 0)
        GR.add_edge(v, sink, GR.out_[v], 0)
        #print("to source", source, u, GR.in_[u], 0)
        #print("to sink", v, sink, GR.out_[v], 0)
...
DEBUG = True
LOG = False
if DEBUG: test = open("tests\\c05", "r")
GR = read_data()
addST(GR)
